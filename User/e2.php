...
<img src="../img/en1.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">

<img src="../img/en2.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/en3.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/en6.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/en5.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<div class="row">
<!-- thumbnails end -->
  <!-- 1st column -->
  <div class="col-md-2">
    <div class="panel panel-info"style="margin-top: 50px;">
      ...
      <div class="panel-body">
        ...
        <ul style="list-style-type:none;margin-left:-20px;">
          <li><a href="e1.php">Home Appliances</a></li>
          <li><a href="e2.php">Kitchen Appliances</a></li>
          <li><a href="e3.php">Mobile Accessories</a></li>
          <li><a href="e4.php">Laptop & Computer</a></li>
          <li><a href="e5.php">Camera Accessories</a></li>
  ...
  <div class="col-md-10 " style="margin-top: 50px;">
    ...
    <div class="row">
     <?php
        ...
        $count=0;
        $fetch=mysqli_query($connect,"SELECT * FROM `products` WHERE cat='kitchen'") or die(mysqli_error($connect));
