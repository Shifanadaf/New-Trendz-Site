...
<img src="../img/d.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">

<img src="../img/d1.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/fr2.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/d3.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/d4.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<div class="row">
  <!-- 1st column -->
  <div class="col-md-2">
    <div class="panel panel-info"style="margin-top: 50px;">
      ...
      <div class="panel-body">
        ...
        <ul style="list-style-type:none;margin-left:-20px;">
          <li><a href="h1.php">Clock</a></li>
          <li><a href="h2.php">Frame</a></li>
          <li><a href="h3.php">Curtain</a></li>
          <li><a href="h4.php">Lights</a></li>
          <li><a href="h5.php">Pillows</a></li>
  ...
  <div class="col-md-10 " style="margin-top: 50px;">
    ...
    <div class="row">
     <?php
        ...
        $count=0;
        $fetch=mysqli_query($connect,"SELECT * FROM `products` WHERE cat='curtain'") or die(mysqli_error($connect));
