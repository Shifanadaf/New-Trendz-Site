...
<img src="../img/fr1.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">

<img src="../img/fr6.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/fr3.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/fr4.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<img src="../img/fr5.jpg" alt="Avatar" style="width:200px; border-radius: 70%;margin-left: 85px;">
<div class="row">
<!-- thumbnails end -->
  <!-- 1st column -->
  <div class="col-md-2">
    <div class="panel panel-info"style="margin-top: 50px;">
      ...
      <div class="panel-body">
        ...
        <ul style="list-style-type:none;margin-left:-20px;">
          <li><a href="f1.php">Sofa</a></li>
          <li><a href="f2.php">Table</a></li>
          <li><a href="f3.php">Bed</a></li>
          <li><a href="f4.php">Chair</a></li>
          <li><a href="f5.php">CupBoard</a></li>
  ...
  <div class="col-md-10 " style="margin-top: 50px;">
    ...
    <div class="row">
     <?php
        ...
        $count=0;
        $fetch=mysqli_query($connect,"SELECT * FROM `products` WHERE cat='sofa'") or die(mysqli_error($connect));
          ...
          <div class="thumbnail" style="height:350px; width:300px;background-color: transparent;">
              ...
              <div class="caption" >
                ...
                <p style="margin-left:40px;"><a href="add.php?id=<?php echo $id;?>&cat=<?php echo $cat;?>" class="btn btn-primary" role="button"style="padding: 2%;    width: 100px;">Add to cart</a>&emsp;
                 <a href="view.php?id=<?php echo $id;?>" class="btn btn-primary" role="button"style="padding: 2%;    width: 100px;">View details</a>  </p>
              </div>
