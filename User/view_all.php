...
<body onload="ShowBanners()" style="background-color: #E2CCF7; " >
<center>
  ...
  <div class="col-md-12 " style="margin-top: 50px;">
    ...
    <div class="row">
     <?php
        ...
        $count=0;
        $fetch=mysqli_query($connect,"SELECT * FROM `products`") or die(mysqli_error($connect));
      ...
      ?>
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail" style="height:400px; width:300px;"><br>
               <img src="../img/<?php echo $row['photo'];?>" alt="loading"height="200px" width="150px">
              <div class="caption" >
                ...
                <p style="margin-left:40px;"><a href="add.php?id=<?php echo $id;?>&cat=<?php echo $cat;?>" class="btn btn-primary" role="button"style="padding: 2%;height: 32px;width: 90px;">Add to cart</a>&emsp;
                 <a href="view.php?id=<?php echo $id;?>&cat=<?php echo $cat;?>" class="btn btn-primary" role="button"style="padding: 2%;height: 32px;width: 90px;">View details</a>  </p>
              </div>
