...
$row=0;
    $update = mysqli_query($connect,"select * from products where id='".$_GET['id']."'") or die(mysqli_error($connect));
...
<div> 
	...
	<!-- header end -->
<!-- cart section start -->
<h1 style="font-family: 'Zapf-Chanceery', cursive;">&emsp;<center>Cart</center></h1><br>
</div></center>
  ...
  <form action="bill.php" method="post"><br><input type="submit" name="placed_order" value="Place Order" style="margin-left: 45%;
    width: 135px;
    height: 40px;"class="btn btn-warning"/></form><br>
