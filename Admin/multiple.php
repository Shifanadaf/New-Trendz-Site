...
</aside>    <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>update kitchenware</strong></h1></center>
  ...
  <div class="panel-body">
        ...
        <form name="add_pro" method="post">
          <div class="form-group">
            <td><label >Enter product product id:</label></td>
            <td><input type="text" readonly="True" class="form-control" name="product_id" value="<?php echo $row['id']; ?>"></td>
          </div>
        </tr>

          <tr>
              <div class="form-group">
               <td> <label >Choose Image for the product:</label><br>
                <img src="..." alt="photonotloaded"></td>
               <td> <input type="file" name="img1" accept=".png, .jpeg, .jpg"></td>
              </div>
          </tr>
          ...
          <tr>
              <div class="form-group">
               <td> <label >Choose Image for the product:</label><br>
                <img src="..." alt="photonotloaded"></td>
               <td> <input type="file" name="img2" accept=".png, .jpeg, .jpg"></td>
              </div>
          </tr>
          ...
          <tr>
              <div class="form-group">
               <td> <label >Choose Image for the product:</label><br>
                <img src="..." alt="photonotloaded"></td>
               <td> <input type="file" name="img3" accept=".png, .jpeg, .jpg"></td>
              </div>
          </tr>
          ...
          <tr>
              <div class="form-group">
               <td> <label >Choose Image for the product:</label><br>
                <img src="..." alt="photonotloaded"></td>
               <td> <input type="file" name="img4" accept=".png, .jpeg, .jpg"></td>
              </div>
          </tr>
          ...
          <tr >
          <td colspan="2" ><center style="margin-left: -70px"><button type="submit"  name="update" class="btn btn-success">Add Images</button>&ensp;
...
extract($_POST);
 ...
 // $photo=$row['photo'];
 // }
$update = mysqli_query($connect,"INSERT INTO `product_image`( `product_id`, `preview_source`) VALUES ('$product_id','$img1'),('$product_id','$img2'),('$product_id','$img3'),('$product_id','$img4');") or die
(mysqli_error($connect));
if($update)
{
echo "<script>;";
echo "window.alert('Image added successfully....!');";
