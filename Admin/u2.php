...
</aside>    <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>update Electronic</strong></h1></center>
  ...
  <div class="panel-body">
        ...
        <form name="add_pro" method="post">
          <div class="form-group">
            ...
            <td><input type="text" class="form-control" name="p_name" value="<?php echo $row['name']; ?>"></td>
          </div>
        </tr>
      ...
      <div class="form-group">
        ...
        <td>
          ...
          <textarea name="about" class="form-control" rows="4" ><?php echo $row['about']; ?></textarea>
        </td>
      </div>
      </tr>
      <tr>
...
extract($_POST);
 ...
 // $photo=$row['photo'];
 // }
$update = mysqli_query($connect,"update `electronic` set 
name='".$p_name."', 
mrp='".$price."',
dealp='".$dprice."', 
photo='".$photo."',
