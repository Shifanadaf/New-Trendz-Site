...
<aside>
 ...
 <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>View Kitchen Products</strong></h1></center>
...
<tbody>
	<?php
	 ...
	 $view = mysqli_query($connect,"SELECT * FROM `products` WHERE cat = 'rack' OR cat='uten' OR  cat='gas' OR cat= 'container' OR cat=  'clean';") or die(mysqli_error($connect));
...
href="u0.php?id=<?php echo $id;$cat;?>"
...
if (isset($_GET['id']))
{
$sel=mysqli_query($connect,"select * from kitchen where
id='".$_GET['id']."' ");
while ($fetch=mysqli_fetch_array($sel))
 ...
 $delete = mysqli_query($connect,"delete from kitchen where
id='".$_GET['id']."'");
