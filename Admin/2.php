...
<aside>
 ...
 <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>View Electronic Products</strong></h1></center>
...
<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="view_pro.php">Furniture </a></li>
            <li><a href="0.php"> Kitchen</a></li>
            <li><a href="1.php">Home Decor</a></li>
            <li><a href="2.php">Electronics </a></li>
...
<tbody>
	<?php
	 ...
	 $view = mysqli_query($connect,"SELECT * FROM `products` WHERE cat = 'home' OR cat='kitchen' OR cat='mobile' OR cat='lc' OR cat='cam';") or die(mysqli_error($connect));
...
href="multiple.php?id=<?php echo $id;?>"
title="Add multiple images"><i class="glyphicon glyphicon-picture"></i></a>  <br> <br>
<a class="text-success" onClick="return confirm('Are you sure you
want to update this product details ?);"
href="u2.php?id=<?php echo $id;$cat;?>"
title="Update registration details"><i class="glyphicon glyphicon-edit"></i></a><br> <br>
<a class="text-danger" onClick="return confirm('Are you sure you want to delete this product details ?);"
href="2.php?id=<?php echo $id;?>"
...
if (isset($_GET['id']))
{
$sel=mysqli_query($connect,"select * from electronic where
id='".$_GET['id']."' ");
while ($fetch=mysqli_fetch_array($sel))
 ...
 $delete = mysqli_query($connect,"delete from electronic where
id='".$_GET['id']."'");
