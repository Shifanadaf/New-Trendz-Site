...
<aside>
 ...
 <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>View Furniture Products</strong></h1></center>
...
<tbody>
	<?php
	 ...
	 $view = mysqli_query($connect,"SELECT * FROM `products` WHERE cat = 'sofa' OR cat='bed' OR cat='table' OR cat='chair' OR cat='cup' ORDER BY id DESC;") or die(mysqli_error($connect));
...
if (isset($_GET['id']))
{
$sel=mysqli_query($connect,"select * from products where
id='".$_GET['id']."' ");
while ($fetch=mysqli_fetch_array($sel))
 ...
 $delete = mysqli_query($connect,"delete from products where
id='".$_GET['id']."'");
