...
<aside>
 ...
 <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>View Home Decor Products</strong></h1></center>
...
<tbody>
	...
	$view = mysqli_query($connect,"SELECT * FROM `products` WHERE cat = 'clock' OR cat='frame' OR cat='curtain' OR cat='light' OR cat='pillow';") or die(mysqli_error($connect));
...
href="u1.php?id=<?php echo $id;$cat;?>"
...
if (isset($_GET['id']))
{
$sel=mysqli_query($connect,"select * from home where
id='".$_GET['id']."' ");
while ($fetch=mysqli_fetch_array($sel))
 ...
 $delete = mysqli_query($connect,"delete from home where
id='".$_GET['id']."'");
