...
</aside>    <center><h1 style="margin-left: 200px; margin-top: 50px;"><strong>update</strong></h1></center>
...
if($_GET['id'])
{
$update = mysqli_query($connect,"select * from furniture where
  ...
  <div class="panel-body">
        ...
        <tr>
          ...
          <div class="form-group">
            ...
            <td><input type="text" class="form-control" name="discription" placeholder="Product Description "></td>
          </div>
          </tr>
...
$update = mysqli_query($connect,"update `furniture` set 
p_name='".$p_name."', 
mrp='".$price."',
dealp='".$dprice."', 
photo='".$photo."',
